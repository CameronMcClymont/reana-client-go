...
## [0.95.0](https://github.com/CameronMcClymont/reana-client-go/compare/v0.95.0-alpha.0...v0.95.0) (2026-09-23)


### ⚠ BREAKING CHANGES

* **client:** `REANA_SERVER_URL` and `REANA_SERVER_TLS_VERIFY` environment variables are no longer client inputs. Unset them and run `login --server URL`, adding `--no-tls-verify` for a self-signed development server when needed.
* **auth:** Use this client with the OIDC-compatible REANA server and run reana-client-go login, or supply an issuer-issued JWT. Legacy opaque REANA tokens no longer authenticate. TLS certificate verification is enabled by default; configure REANA_SERVER_CA_CERTS for private certificates. Replace static-token automation with credentials whose refresh-token lifetime and rotation policy fit the job, and upgrade the client and cluster together for the OIDC cut-over.

### Build

* **make:** add configurable installation targets ([#202](https://github.com/CameronMcClymont/reana-client-go/issues/202)) ([5548270](https://github.com/CameronMcClymont/reana-client-go/commit/55482705451de9b2f00460537b4c051bac19be8b))


### Features

* **auth:** add OIDC login and credential management ([#201](https://github.com/CameronMcClymont/reana-client-go/issues/201)) ([fa5a5a9](https://github.com/CameronMcClymont/reana-client-go/commit/fa5a5a92d68406f6a1a1b1d2f5d75e381aceafd1))
* **client:** manage saved REANA server connections ([#214](https://github.com/CameronMcClymont/reana-client-go/issues/214)) ([0618535](https://github.com/CameronMcClymont/reana-client-go/commit/06185358a9645cab2c05a9d7995a78a2a5c806a0))
* **client:** save server and TLS settings at login ([#213](https://github.com/CameronMcClymont/reana-client-go/issues/213)) ([726a34b](https://github.com/CameronMcClymont/reana-client-go/commit/726a34b20f70f666a68ce002100fa53d6b31c347))
