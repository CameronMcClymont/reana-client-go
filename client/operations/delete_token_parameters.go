...
type DeleteTokenParams struct {
	...
	/* XTokenManagementSecret.

	   REANA user token management secret
	*/
	XTokenManagementSecret string

	/* Data.

	   Data required to identify the target user (exactly one of `user_id` or `email` must be provided).
	*/
...
// WithXTokenManagementSecret adds the xTokenManagementSecret to the delete token params
func (o *DeleteTokenParams) WithXTokenManagementSecret(xTokenManagementSecret string) *DeleteTokenParams {
	o.SetXTokenManagementSecret(xTokenManagementSecret)
	return o
}

// SetXTokenManagementSecret adds the xTokenManagementSecret to the delete token params
func (o *DeleteTokenParams) SetXTokenManagementSecret(xTokenManagementSecret string) {
	o.XTokenManagementSecret = xTokenManagementSecret
}

// WithData adds the data to the delete token params
func (o *DeleteTokenParams) WithData(data DeleteTokenBody) *DeleteTokenParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the delete token params
func (o *DeleteTokenParams) SetData(data DeleteTokenBody) {
	o.Data = data
}
...
func (o *DeleteTokenParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// header param X-Token-Management-Secret
	if err := r.SetHeaderParam("X-Token-Management-Secret", o.XTokenManagementSecret); err != nil {
		return err
	}
